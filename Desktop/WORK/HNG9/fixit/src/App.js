import { PageBody, Header, HeaderLHS, HeaderRHS, ContentContainer, DescriptionContainer, DescriptionHeaderText, DescriptionHeaderCon, AboutBizHeader, EditBtn, Accent, BusinessInfoContainer, BusinessInfo } from './App.styled'
    ...
    <PageBody>
      <Header>
        <HeaderLHS>
          ...
          <span>My<Accent>Profile</Accent></span>
        </HeaderLHS>
        <HeaderRHS>
